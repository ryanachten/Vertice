...
var toggleContextPanelScript : CollectObjContextPanelToggle;
...
function UpdateContextInfo()
{
	...
	else if (cntxtMediaNodes.Count == 0 || cntxtMediaNodes.Count == null) //HERE
	{
		contextualMediaButton.SetActive(false); 	
	}
